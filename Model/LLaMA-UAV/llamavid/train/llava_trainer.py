...
class LLaVATrainer(Trainer):
    ...
    def _save_checkpoint(self, model, trial, metrics=None):
        if getattr(self.args, 'tune_mm_mlp_adapter', False):
            ...
            self.args.output_dir = os.path.join(run_dir, checkpoint_folder)
            ...
            if self.args.local_rank == 0 or self.args.local_rank == -1:
                ...
                torch.save(weight_to_save, os.path.join(self.args.output_dir, f'mm_projector.bin'))
            ...
            if self.args.lora_enable:
                ...
                if self.args.local_rank == 0 or self.args.local_rank == -1:
                    ...
                    safe_save_model_for_hf_trainer(trainer=self, output_dir=self.args.output_dir)
            
            if self.is_deepspeed_enabled:
                tag = f"global_step{self.state.global_step}"
                self.model_wrapped.save_checkpoint(self.args.output_dir, tag=tag)
