...
base_dir=/home/fit/qiuhan/WORK/wmq/TravelUAV_ws
root_dir=$base_dir/TravelUAV
...
deepspeed \
    ...
    --dataset_path $base_dir/TravelUAV_data/TravelUAV \
    --output_dir $model_dir/work_dirs/llama-vid-7b-pretrain-224-uav-full-data-lora32_bs128_1 \
